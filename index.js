...
let flavorSelection = userPreference === 'Sugar-free' ? 'Sugar-free' : userPreference === 'Regular' ? 'Regular' : 'undefined';
...
let heartRate = 101; // Current heart rate in bpm
...
let LateNightCodingSession = currentHour >= 7 && currentHour <= 24 ? "Unleash the beast!" : "Better stick to water.";
console.log(LateNightCodingSession)
